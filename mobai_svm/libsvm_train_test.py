...
def train_svm(strInputBonafideFeaturesFolders, strInputAttacksFeaturesFolders, strSavingModelFilePath, param_str=None, oversampled=False, feat_shapes=(49,512)):
    if not os.path.exists(strSavingModelFilePath):
        os.makedirs(strSavingModelFilePath)

    train_loader = data_loader(strInputAttacksFeaturesFolders, strInputBonafideFeaturesFolders, flag='1_training_set' , feat_shape=feat_shapes)
...
def test_svm(strInputBonafideFeaturesFolders, strInputAttacksFeaturesFolders, strSavingModelFilePath, load_preds=False, feat_shapes=(49,512)):
